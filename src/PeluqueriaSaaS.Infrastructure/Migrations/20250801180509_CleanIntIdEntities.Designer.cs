...
namespace PeluqueriaSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250801180509_CleanIntIdEntities")]
    partial class CleanIntIdEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeluqueriaSaaS.Domain.Entities.Articulo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "TipoArticuloId");
            ...
            modelBuilder.Entity("PeluqueriaSaaS.Domain.Entities.EstadoWorkflow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TipoWorkflow")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("TipoWorkflow", "EsActivo");

                    b.HasIndex("TipoWorkflow", "EsEstadoFinal");

                    b.HasIndex("TipoWorkflow", "EsEstadoInicial")
                        .IsUnique()
                        .HasFilter("[EsEstadoInicial] = 1");

                    b.HasIndex("TipoWorkflow", "Orden");

                    b.ToTable("EstadosWorkflow");
                });
            ...
            modelBuilder.Entity("PeluqueriaSaaS.Domain.Entities.TipoArticulo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeluqueriaSaaS.Domain.Entities.VentaDetalle", b =>
                {
                    ...
                    b.Property<int?>("EmpleadoTrabajandoId")
                        .HasColumnType("int");

                    b.Property<int?>("EstadoWorkflowId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("FechaCompletadoTrabajo")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("EmpleadoTrabajandoId", "EstadoWorkflowId");
            ...
            modelBuilder.Entity("PeluqueriaSaaS.Domain.Entities.Articulo", b =>
                {
                    b.HasOne("PeluqueriaSaaS.Domain.Entities.TipoArticulo", "TipoArticulo")
                        .WithMany()
            ...
            modelBuilder.Entity("PeluqueriaSaaS.Domain.Entities.VentaDetalle", b =>
                {
                    b.HasOne("PeluqueriaSaaS.Domain.Entities.Articulo", "Articulo")
                        .WithMany()
                        .HasForeignKey("ArticuloId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("PeluqueriaSaaS.Domain.Entities.Empleado", "EmpleadoTrabajando")
                        .WithMany()
                        .HasForeignKey("EmpleadoTrabajandoId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PeluqueriaSaaS.Domain.Entities.EstadoWorkflow", "EstadoWorkflow")
                        .WithMany()
                        .HasForeignKey("EstadoWorkflowId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("EmpleadoTrabajando");

                    b.Navigation("EstadoWorkflow");
